...
except ImportError:  # pragma: no cover - handled at runtime when Gemini is requested
    genai = None
...
def _generate_with_gemini(
    ...
    if genai is None:
        raise RuntimeError(
            "google-genai is not installed. Install backend/requirements.txt dependencies before using Gemini mode."
        )
