...
async def create_forecast(
    ...
    include_summary: bool = Query(
        default=True,
        description="When false, return route weather first and skip summary generation.",
    ),
) -> ForecastResponse:
    """Validate a route and return waypoint weather, optionally with summary/validation."""
